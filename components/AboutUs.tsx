...
export default function AboutUs() {
  ...
  return (
    <motion.section id="about-us" className="py-16 sm:py-24 px-4 sm:px-6 bg-[#B2B2AC]/10" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={containerVariants}>
      <div className="max-w-7xl mx-auto">
        <motion.h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-10 sm:mb-16 text-[#3A3A3A]" variants={itemVariants}>Über uns</motion.h2>
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          <motion.div variants={itemVariants}>
            <img src={about_processBackground} alt="Unser Team" className="rounded-2xl sm:rounded-3xl shadow-2xl w-full" />
          </motion.div>
          <motion.div className="space-y-6 sm:space-y-8" variants={containerVariants}>
            <motion.p className="text-base sm:text-lg md:text-xl leading-relaxed text-[#3A3A3A]" variants={itemVariants}>
