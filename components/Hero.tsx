    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
                <motion.h1
                    className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-4 sm:mb-6 drop-shadow-2xl leading-tight"
                    variants={itemVariants}
                >
                    SicherPro Wachschutz GmbH
                </motion.h1>
                <motion.p
                    className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-[#D9DEDF] mb-6 sm:mb-8 drop-shadow-lg"
                    variants={itemVariants}
                >
                    auf höchstem Niveau
                </motion.p>
                <motion.p
                    className="text-base sm:text-lg md:text-xl text-[#D9DEDF] mb-8 sm:mb-12 max-w-3xl mx-auto drop-shadow-md"
                    variants={itemVariants}
                >
                ...
                <Link href="/kontakt">
                    <motion.button
                        className="bg-[#587D85] text-white px-6 sm:px-10 py-3 sm:py-5 rounded-full text-base sm:text-lg font-semibold hover:bg-[#3A3A3A] transition-all duration-300 shadow-2xl"
                        variants={itemVariants}
